...
#include "SourceTermG2.h"

registerMooseObject("Neutron_TransportApp", SourceTermG2);

template<>
InputParameters validParams<SourceTermG2>()
{
...
SourceTermG2::SourceTermG2(const InputParameters & parameters): 
    Kernel(parameters),
