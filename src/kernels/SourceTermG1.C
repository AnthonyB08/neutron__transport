...
#include "SourceTermG1.h"

registerMooseObject("Neutron_TransportApp", SourceTermG1);

template<>
InputParameters validParams<SourceTermG1>()
{
...
SourceTermG1::SourceTermG1(const InputParameters & parameters): 
    Kernel(parameters),
...
Real
SourceTermG1::computeQpResidual()
{
 return (_sigma_sa) * _test[_i][_qp];
}

Real
SourceTermG1::computeQpJacobian()
{
